...
if (Test-Path $XtermFolder -PathType Container)
{
	...
	Write-Host -ForegroundColor Green "`n:: Finished! To watch changes, open the Val - Code terminal in the xterm.js repo and run:`n`n    yarn package -- --mode development --watch"
}
else
{

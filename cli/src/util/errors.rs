...
// When the provided connection token doesn't match the one used to set up the original Val - Code Server
...
// When the Val - Code server has an unrecognized extension (rather than zip or gz)
#[derive(Debug)]
...
/// Internal errors in the Val - Code CLI.

 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Val - Code UI).
 */
 ...
 * to represent terminals that appear in other parts of the Val - Code UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Val - Code OSC `SetMarker`

...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Val - Code's "shell environment" that may
	 ...
	 * a terminal used to drive some Val - Code feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Val - Code and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Val - Code shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
